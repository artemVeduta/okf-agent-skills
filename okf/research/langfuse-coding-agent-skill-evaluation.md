...
[`v0.1.0` completion specification](../references/okf-agent-skills-v0.1.0-completion.md#testing-decisions).
...
3. [`v0.1.0` specification](../references/okf-agent-skills-v0.1.0.md)
4. [`v0.1.0` completion specification](../references/okf-agent-skills-v0.1.0-completion.md)
